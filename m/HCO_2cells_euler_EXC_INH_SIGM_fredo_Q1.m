...
% Initial values
V1= -44; V2= -44; Ca1=.2; Ca2=1.5; h1 =0; h2 =0; n1 =0; n2 =0; 
...
%  hold on
 ...
 ylim([-85 40])
  fftt = 28;
txpo = text(-6,25,'B','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')
...
subplot(4,1,4)
 ...
 xlabel('Time [sec]','Fontsize', 16),ylabel('[Ca]','Fontsize', 16)
  ...
  print(gcf,'-djpeg','-r600' ,'fredo_Q1b.jpeg');
...
%------------------- plot SNIC ---------------------
plot(Ca_cod_bkgh0,x_cod_bkgh0-0.08,'-.','Color',[.1 .1 .5 ],'LineWidth',1)
hold on
plot(Ca_cod_fdgh0,x_cod_fdgh0-0.08,'-.','Color',[.1 .1 .5 ],'LineWidth',1)
hold on


plot(Ca_cod_bkgh0,x_cod_bkgh0-.12,'-.','Color',[.1 .5 .1 ],'LineWidth',1)
hold on
plot(Ca_cod_fdgh0,x_cod_fdgh0-.12,'-.','Color',[.1 .5 .1 ],'LineWidth',1)
hold on


axis([0.01 1.8 0.01 1.02])

fftt = 28;
txpo = text(-.12,.98,'А','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')

fftt = 15;
%txpo = text(0.25,.13,'[Ca]^\prime=0','Fontsize',fftt,'Color','red','FontName','Arial')

fftt = 15;
txpo = text(1.1,.48,'[Ca]^\prime=0','Fontsize',fftt,'Color','red','FontName','Arial')


fftt = 16;
txpo = text(1.3,.13,'x^\prime=0','Fontsize',fftt,'Color','black','FontName','Arial')

fftt = 16;
txpo = text(.03,.25,'SNIC','Fontsize',fftt,'Color',[0.6 0.6 0.6],'FontName','Arial')
...
print(gcf,'-djpeg','-r600' ,'fredo_Q1a.jpeg');
