...
fftt = 15;
txpo = text(0.6,0,20,'M_{po}','Fontsize',fftt,'Color','black','FontName','Arial')
txpo = text(0.6,0,-25,'\langle V \rangle ','Fontsize',fftt,'Color','black','FontName','Arial')
...
txpo = text(1.15,0,-30,'M_{eq}=0','Fontsize',fftt,'Color','black','FontName','Arial')
...
axis([.5 1.1 0.0 1.5 -72 35] )
%axis tight 

 %print(gcf,'-djpeg','-r600' ,'nemo3D_Ca_n_bursting_short.jpeg');
