...
% Initial values
V1= -44; V2= -44; Ca1=.7; Ca2=1.; h1 =0; h2 =0; n1 =0; n2 =0; x1 =0.7;
x2 =.4; y1 =0; y2 =0; s1 =0; s2 =0; m1 =0; m2 =0;
...
%  hold on
 ...
 ylim([-80 40])
  fftt = 28;
txpo = text(17,25,'B','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')
...
subplot(4,1,4)
 ...
 xlabel('Time [sec]','Fontsize', 16),ylabel('[Ca]','Fontsize', 16)
  ...
  print(gcf,'-djpeg','-r600' ,'fredo14b.jpeg');
...
fftt = 15;
txpo = text(0.27,.18,'[Ca]^\prime=0','Fontsize',fftt,'Color','red','FontName','Arial')
...
fftt = 16;
txpo = text(.13,.4,'SNIC','Fontsize',fftt,'Color',[0.6 0.6 0.6],'FontName','Arial')
...
print(gcf,'-djpeg','-r600' ,'fredo14a.jpeg');
...
xlabel('[Ca]_1-variable','Fontsize', 16),
  ylabel('[Ca]_2-variable','Fontsize', 16)  
    fftt = 28;
txpo = text(0.57,1.74,'С','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')
