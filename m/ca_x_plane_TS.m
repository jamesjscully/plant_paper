...
%------------------- plot SNIC ---------------------
plot(Ca_cod_bkgh0,x_cod_bkgh0-.022,'-.','Color',[.9 .7 .1 ],'LineWidth',2)
hold on
plot(Ca_cod_fdgh0,x_cod_fdgh0-0.022,'-.','Color',[0.95 .7 .1 ],'LineWidth',2)
hold on
...
xvar= x(5,1:end-43);
Cavar=x(6,1:end-43);
% plot (1.5*Cavar,1.5*xvar*.93,'--','Color',[.1 .0 .6 ],'LineWidth',2)
hold on
