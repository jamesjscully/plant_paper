...
%------------------- plot SNIC ---------------------
plot(Ca_cod_bkgh0,x_cod_bkgh0,'--','Color',[.6 .6 .6 ],'LineWidth',2)
hold on
plot(Ca_cod_fdgh0,x_cod_fdgh0,'--','Color',[.6 .6 .6 ],'LineWidth',2)
hold on
...
xvar= x(5,1:end);
Cavar=x(6,1:end);
%plot (Cavar,xvar,'Color',[.5 .1 .2 ],'LineWidth',10)
hold on
...
Cavar=x(6:28:end-1,:);
xvar =x(5:28:end-1,:);
plot (Cavar,xvar,'Color',[.1 .3 .8 ],'LineWidth',2)
hold on

load('transient1.mat')
Cavar=x(6:28:end-1,:);
xvar =x(5:28:end-1,:);
%plot (Cavar,xvar,'Color',[.1 .9 .8 ],'LineWidth',1)
hold on

load('transient.mat')
Cavar=x(6:28:end-1,:);
xvar =x(5:28:end-1,:);
%plot (Cavar,xvar,'Color',[.9 .3 .8 ],'LineWidth',1)
hold on
