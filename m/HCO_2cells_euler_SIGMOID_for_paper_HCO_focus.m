...
% Initial values
V1= -44; V2= 20; Ca1=.2; Ca2=1.07; h1 =0; h2 =0; n1 =0; n2 =0; x1 =0.1;
x2 =.95; y1 =0; y2 =0; s1 =0; s2 =0; m1 =0; m2 =0;
...
clf
 ...
 ylim([-85 40])
  fftt = 28;
txpo = text(-6.8,25,'B','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')
 ...
 xlabel('Time [sec]','Fontsize', 14),ylabel('[Ca]','Fontsize', 16)
  ...
  %print(gcf,'-djpeg','-r600' ,'HCO3a.jpeg');
...
plot(Caa1(pos),xx1(pos),'.','Color',[0.5 0.7 1],'MarkerSize',40)
  ...
  % print(gcf,'-djpeg','-r600' ,'HCO3.jpeg');
