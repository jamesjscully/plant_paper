...
% Initial values
V1= -45; V2= -15; Ca1=.4; Ca2=.72; h1 =0; h2 =0; n1 =0; n2 =0; 
x1 =0.67;x2 =.8; y1 =0; y2 =0; s1 =0; s2 =0; m1 =0; m2 =0;
...
[v2min,tp2min] = findpeaks(-vv2,time,'MinPeakProminence',1);
...
txpo = text(-82.2,25,'B','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')
 ...
 hold on
[Ca1min,tp1min] = findpeaks(-Caa1,time,'MinPeakProminence',.001);
[Ca2min,tp2min] = findpeaks(-Caa2,time,'MinPeakProminence',.001);
...
%------------------- plot SNIC ---------------------
plot(Ca_cod_bkgh0,x_cod_bkgh0+0.0,'-.','Color',[.85 .85 .85 ],'LineWidth',2)
hold on
plot(Ca_cod_fdgh0,x_cod_fdgh0+0.0,'-.','Color',[.85 .85 .85 ],'LineWidth',2)
hold on

axis([0.3 1.4 0.05 1.0])
...
plot (Ca2,x1,'-.','Color',[0 0.5 0.99],'LineWidth',1)
hold on
...
hold on
  ...
  hold on
  plot3(Caa1,xx1,vv1,'Color',[0. 0.0 0.8],'Linewidth',.1)
  hold on
  tran=8000;
