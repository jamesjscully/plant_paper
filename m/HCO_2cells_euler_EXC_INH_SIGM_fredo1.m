...
% Initial values
V1= -44; V2= -44; Ca1=.5; Ca2=1.3; h1 =0; h2 =0; n1 =0; n2 =0; x1 =0.2;
x2 =.92; y1 =0; y2 =0; s1 =0; s2 =0; m1 =0; m2 =0;
...
subplot(4,1,4)
 ...
 xlabel('Time [sec]','Fontsize', 16),ylabel('[Ca]','Fontsize', 16)
  %title('Ca and Ca-activaterd possasion gating varaible in time', 'Fontsize', 11);
   ...
   print(gcf,'-djpeg','-r600' ,'fredo1b.jpeg');
...
axis([0.2 1.4 0.15 1.0])

fftt = 28;
txpo = text(0.1,.98,'А','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')

fftt = 16;
txpo = text(0.61,.5,'[Ca]^\prime=0','Fontsize',fftt,'Color','red','FontName','Arial')

fftt = 16;
txpo = text(1.15,.3,'x^\prime=0','Fontsize',fftt,'Color','black','FontName','Arial')

fftt = 16;
txpo = text(.3,.495,'SNIC','Fontsize',fftt,'Color',[0.6 0.6 0.6],'FontName','Arial')
...
plot (Ca2,x1,'Color',[0 0.6 0.0],'LineWidth',2)
hold on
...
%x22=Ca1./(0.0085*(140-V1+dca));
plot (Ca2,x1,'Color',[0 0 0.7],'LineWidth',1)
hold on
...
hold on
 ...
 print(gcf,'-djpeg','-r600' ,'fredo1a.jpeg');
