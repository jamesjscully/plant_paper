...
subplot(4,1,4)
 ...
 xlabel('Time [sec]','Fontsize', 16),ylabel('[Ca]','Fontsize', 16)
  ...
  print(gcf,'-djpeg','-r600' ,'fredo13b.jpeg');
...
fftt = 15;
txpo = text(0.17,.08,'[Ca]^\prime=0','Fontsize',fftt,'Color','red','FontName','Arial')
...
print(gcf,'-djpeg','-r600' ,'fredo13a.jpeg');
...
xlabel('[Ca]_1-variable','Fontsize', 16),
  ylabel('[Ca]_2-variable','Fontsize', 16)  
    fftt = 28;
txpo = text(0.13,1.74,'С','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')

ylim([1.4  1.75])
  xlim([0.2 0.9])
  
  print(gcf,'-djpeg','-r600' ,'fredo13c.jpeg');