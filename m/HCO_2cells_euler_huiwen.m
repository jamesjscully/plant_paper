...
% Initial values
V1= -44; V2= -44; Ca1=.2; Ca2=0.2; h1 =0; h2 =0; n1 =0; n2 =0; x1 =0.8;
x2 =1.0; y1 =0; y2 =0; s1 =0; s2 =0; m1 =0; m2 =0;
...
s1 =s1+step*(alpha*(1-s1)/(1+exp(-100*(V1+20)))-beta*s1);
s2 =s2+step*(alpha*(1-s2)/(1+exp(-100*(V2+20)))-beta*s2);
