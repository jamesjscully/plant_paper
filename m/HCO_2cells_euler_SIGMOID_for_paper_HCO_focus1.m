...
% Initial values
V1= -44; V2= 20; Ca1=.2; Ca2=1.07; h1 =0; h2 =0; n1 =0; n2 =0; 
x1 =0.5; x2 =.9; y1 =0; y2 =0; s1 =0; s2 =0; m1 =0; m2 =0;
...
txpo = text(-4.4,25,'B','Fontsize',fftt,'Color','black','FontName','Arial','FontWeight','bold')
 ...
 xlabel('Time [sec]','Fontsize', 14),ylabel('[Ca]','Fontsize', 16)
  ...
  print(gcf,'-djpeg','-r600' ,'HCO4b.jpeg');
  ...
  hold on
  plot(Caa2,xx2,'Color',[0. 0.6 0.],'Linewidth',2.)
  hold on
...
fftt = 15;
txpo = text(0.13,.07,'[Ca]^\prime=0','Fontsize',fftt,'Color','red','FontName','Arial')

fftt = 16;
txpo = text(1.2,.04,'x^\prime_{\rm inh}=0','Fontsize',fftt,'Color','black','FontName','Arial')
