...
% Initial values
V1= -44; V2= -44; Ca1=.5; Ca2=1.; h1 =0; h2 =0; n1 =0; n2 =0; x1 =0;
...
s1 =s1+step*(alpha1*s1*(1-s1)/(1+exp(-10*(V1+30)))-beta1*(s1-0.00001));
s2 =s2+step*(alpha2*s2*(1-s2)/(1+exp(-10*(V2+35)))-beta2*(s2-0.00001));
