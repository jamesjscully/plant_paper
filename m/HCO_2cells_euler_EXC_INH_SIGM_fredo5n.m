...
% Initial values
V1= -44; V2= -44; Ca1=.6; Ca2=1.3; h1 =0; h2 =0; n1 =0; n2 =0; 
x1 =.8; x2 =.92; y1 =0; y2 =0; s1 =0; s2 =0; m1 =0; m2 =0;
...
subplot(4,1,4)
 ...
 xlabel('Time [sec]','Fontsize', 14),ylabel('[Ca]','Fontsize', 16)
  ...
  %print(gcf,'-djpeg','-r600' ,'fredo5b.jpeg');

  toc 
   figure(5)
 clf
 st=1;
 plot(Caa1(st:end),xx1(st:end),'Color',[0. 0. 0.6],'LineWidth',2)
  hold on
...
plot (Ca2,x1,'Color',[0 0.99 0.0],'LineWidth',1)
hold on
...
%x22=Ca1./(0.0085*(140-V1+dca));
plot (Ca2,x1,'Color',[0 0.1 0.99],'LineWidth',1)
hold on
...
print(gcf,'-djpeg','-r600' ,'fredo5a.jpeg');
