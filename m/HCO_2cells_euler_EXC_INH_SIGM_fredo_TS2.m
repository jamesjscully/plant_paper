...
% Initial values
V1= -44; V2= -44; Ca1=.1; Ca2=1.3; h1 =0; h2 =0; n1 =0; n2 =0; 
...
%all currents  
Q1 =-gsyn*(V1-40) -Iapp -INa  -IK -Ittx -Ileak -Ihh;
...
% nullcline Ca'=0
Q11=-gsyn*(V1-40)-Iapp+gI*minf.^3.*h1.*(VI-V1) + gK*n1.^4.*(VK-V1) +0.03*Ca1.*(V1+75)./(0.5+Ca1) -gL*(V1-VL) -gh*(((1./(1.+exp(-(V1+63.)/7.8))).^3).*y1.*(V1-70));
x11=Q11./(gT*(VI-V1));
