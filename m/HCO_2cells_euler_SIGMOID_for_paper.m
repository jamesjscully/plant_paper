...
% Initial values
V1= -44; V2= -44; Ca1=.2; Ca2=1.15; h1 =0; h2 =0; n1 =0; n2 =0; x1 =0.9;
...
clf
 ...
 hold on
 xlabel('Time','Fontsize', 14),ylabel('Voltage 1','Fontsize', 14)
 xlim([0 time(end)]) 
 ylim([-85 40])
 ...
 hold on
 xlabel('Time','Fontsize', 14),ylabel('Voltage 2','Fontsize', 14)
 xlim([0 time(end)]) 
 ylim([-85 40])
 box on 
  %xlim([350 time(end)])
  ...
  subplot(4,1,3)
  plot(time,ss1,'Color',[0. 0.0 0.8],'Linewidth',2)
  hold on
  plot(time,ss2,'Color',[0.0 0.7 0.0],'Linewidth',2)
  hold on
  ylim([-.1 1.])
  xlim([0 time(end)])
  xlabel('Time','Fontsize', 14),ylabel('S(t)','Fontsize', 14)
  ...
  ylim([0.0 1.2])
  xlim([0 time(end)])
 xlabel('Time','Fontsize', 14),ylabel('[Ca]','Fontsize', 14)
